                ...
                <div class="container-fluid">
                   <div class="panel panel-headline">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Tambah Postingan</h3>
                                       <?php
                                if(isset($_GET['pesan'])){?>
                                ...
                                <div class="panel-body">
                                    <form method="post" action="blog_upload.php">
                                        <div class="form-floating mb-3">
                                          <input type="text" class="form-control" id="floatingInputDisabled" name="judul" placeholder="judul" required>
                                          <label for="floatingInputDisabled">Judul</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                          <input type="text" class="form-control" id="floatingInputDisabled" name="sub" placeholder="sub judul" required>
                                  ...
                                  <div class="mb-3 row">
                                    ...
                                    <div class="form-floating">
                                      <textarea class="form-control" name="blog" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
                                    </div>
                                  </div>
                                   <div class="mb-3 row">
                                    <div class="form-floating">
